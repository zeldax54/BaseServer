...
(function (BaseServer) {
    ...
    })(Administration = BaseServer.Administration || (BaseServer.Administration = {}));
...
(function (BaseServer) {
    ...
    })(BasicSamples = BaseServer.BasicSamples || (BaseServer.BasicSamples = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = BaseServer.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = BaseServer.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = BaseServer.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (BaseServer) {
    ...
    })(Common = BaseServer.Common || (BaseServer.Common = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var Common;
...
(function (BaseServer) {
    ...
    })(Northwind = BaseServer.Northwind || (BaseServer.Northwind = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var Northwind;
...
(function (BaseServer) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'BaseServer.Northwind.Gender', 'BaseServer.Northwind.Entities.Gender');
    })(Northwind = BaseServer.Northwind || (BaseServer.Northwind = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
...
(function (BaseServer) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'BaseServer.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = BaseServer.Northwind || (BaseServer.Northwind = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
...
(function (BaseServer) {
    ...
    })(Authorization = BaseServer.Authorization || (BaseServer.Authorization = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var Administration;
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(BaseServer.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(BaseServer.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        BaseServer.Common.ReportHelper.execute({
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: BaseServer.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: BaseServer.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new BaseServer.Northwind.OrderDialog();
                        ...
                        var chai = BaseServer.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = BaseServer.Northwind.EmployeeRow.getLookup().items
        ...
        }(BaseServer.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(BaseServer.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.OrderDialog));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    BaseServer.Northwind.CategoryService.Retrieve({
        ...
        }(BaseServer.Northwind.CategoryDialog));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(BaseServer.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new BaseServer.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                BaseServer.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(BaseServer.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    BaseServer.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(BaseServer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(BaseServer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    BaseServer.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return BaseServer.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return BaseServer.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return BaseServer.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return BaseServer.LanguageList.getValue();
            };
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.SupplierDialog));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(BaseServer.Northwind.SupplierGrid));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return BaseServer.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return BaseServer.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return BaseServer.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return BaseServer.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                BaseServer.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    BaseServer.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(BaseServer.Northwind.CustomerDialog));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.CustomerGrid));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = BaseServer.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(BaseServer.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return BaseServer.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BaseServer.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(BaseServer.Northwind.OrderDetailDialog));
...
(function (BaseServer) {
    ...
    (function (Northwind) {
        ...
        }(BaseServer.Common.GridEditorBase));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Northwind.OrderDetailsEditor));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return BaseServer.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return BaseServer.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return BaseServer.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return BaseServer.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new BaseServer.BasicProgressDialog();
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        ...
        }(BaseServer.Common.BulkServiceAction));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return BaseServer.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return BaseServer.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return BaseServer.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(BaseServer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new BaseServer.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new BaseServer.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new BaseServer.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (BaseServer) {
    ...
    BaseServer.SelectableEntityGrid = SelectableEntityGrid;
})(BaseServer || (BaseServer = {}));
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return BaseServer.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return BaseServer.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return BaseServer.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(BaseServer.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = BaseServer.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            BaseServer.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return BaseServer.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return BaseServer.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return BaseServer.Northwind.ProductService.baseUrl; };
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return BaseServer.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return BaseServer.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return BaseServer.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return BaseServer.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (BaseServer) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return BaseServer.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return BaseServer.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return BaseServer.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (BaseServer) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = BaseServer.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = BaseServer.LanguageList || (BaseServer.LanguageList = {}));
})(BaseServer || (BaseServer = {}));
...
(function (BaseServer) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = BaseServer.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = BaseServer.ScriptInitialization || (BaseServer.ScriptInitialization = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    ...
    BaseServer.BasicProgressDialog = BasicProgressDialog;
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var DialogUtils;
    ...
    })(DialogUtils = BaseServer.DialogUtils || (BaseServer.DialogUtils = {}));
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var Common;
...
(function (BaseServer) {
    ...
    BaseServer.StaticTextBlock = StaticTextBlock;
})(BaseServer || (BaseServer = {}));
var BaseServer;
(function (BaseServer) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: BaseServer.Authorization.userDefinition.DisplayName,
